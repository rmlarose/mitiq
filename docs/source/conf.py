...
# "pydata_sphinx_theme"  # 'alabaster', 'sphinx_rtd_theme'
...
extra_navbar = "<p>Because evolution is <a href='https://en.wikipedia.org/wiki/Unitarity_(physics)'>unitary</a>.</p>"
# Add any paths that contain custom static files (such as style sheets) here,
# relative to this directory. They are copied after the builtin static files,
# so a file named "default.css" will overwrite the builtin "default.css".
#html_static_path = ['_static']
#html_css_files = ["uf.css"]

# display logo on top-left of html pages
html_logo = "img/unitary_fund_logo.png"
html_favicon = "_static/logo.png"
html_title = "Mitiq Documentation"
